...
public class DoUongFragment extends Fragment {
    ...
    private List<DoAn> doUongList;
    private DoAnAdapter doUongapdapter;
     ...
     * @return A new instance of fragment DoUongFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcvDoUong = view.findViewById(R.id.recycle_view_douong);
        doUongList = new ArrayList<>();
        GridLayoutManager gridLayoutManager = new GridLayoutManager(view.getContext(), 2);
        rcvDoUong.setLayoutManager(gridLayoutManager);
        doUongapdapter = new DoAnAdapter();
        doUongapdapter.setData(doUongList, view.getContext());
        getListDoUong();
        rcvDoUong.setAdapter(doUongapdapter);
        return view;
    }

    private void getListDoUong() {
